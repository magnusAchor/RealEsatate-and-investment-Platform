    ...
    foreach ($posts as $row) {
        ...
        if ($postID !== $currentPostID) {
            ...
            if ($currentPostID !== null) {
             ...
             loading="lazy">';
                         echo '<fieldset id="post-container" class="post-container" loading="lazy">';
                         echo '<div>';
            ...
            // Display the post container and button for the new post ID
            echo '<div class="center-container-media"  justify-content: center;  z-index: 2; "loading="lazy">';
...
@media (width: 375px) {
    fieldset.post-container {
        min-width: 340px;
        max-width: 340px;
        margin-inline-start: 250px; /* Adjust margin as needed */
    }
    .post-container-media-media {
    padding: 5px;
    border: 1px solid #ccc;
