...
<br><br><br><br><br><br><h1>workspace</h><br><br>
    ...
    $bonding = "
    SELECT workspace_name, group_id, MAX(group_id) AS max_group_id
    FROM chat
    WHERE workers_id = '$userID' AND workspace_name IS NOT NULL
...
";
       ...
       if ($hired->num_rows > 0) {
         ...
         foreach ($rows as $row) {
           ...
           echo '<fieldset style="width: 500px; height: 100px; max-width: 300px;   ">';
...
<div id="popup" class="popup">
  ...
  <form method="post" action="workspace">
    ...
    $bonding = "SELECT * FROM relationship WHERE worker_id = $userID ORDER BY id DESC";
    $hired = $conn->query($bonding);
